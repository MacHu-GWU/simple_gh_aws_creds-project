# -*- coding: utf-8 -*-
#
# simple_gh_aws_creds documentation build configuration file, created by
...
import simple_gh_aws_creds as package
...
# Add data for Jinja2
try:
    from simple_gh_aws_creds.docs import doc_data
except:
    doc_data = dict()
